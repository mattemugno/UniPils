...
def find_all_links(browser, soup, links_ratebeer):
    for item in soup.find_all(class_="BeerTab___StyledDiv-gWeJQq JvNzg"):
        ...
        # print("https://www.ratebeer.com/" + href)
        ...
        # button = browser.find_element_by_xpath('/html/body/div[1]/div[2]/div[2]/div/div/div/div[2]/div[2]/div['
        # '21]/div[2]/div/div[3]/button[2]')
